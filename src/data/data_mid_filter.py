...
def main(input_path="data/letterboxd_filtered_omdb.jsonl", output_path="data/letterboxd_filtered_mid.jsonl"):
...
if __name__ == "__main__":
    main(input_path="data/letterboxd_filtered_omdb.jsonl", output_path="data/letterboxd_filtered_mid.jsonl")
